...
$.extend($.validator, {
	...
	messages: {
		...
		accept: "Por favor ingrese una extension valida.",
		maxlength: $.validator.format("Please enter no more than {0} characters."),
		minlength: $.validator.format("Por favor ingrese mínimo  {0} caracteres."),
		rangelength: $.validator.format("Por favor ingrese un valor entre {0} y {1} carateres de longuitud."),
		...
		min: $.validator.format("Por favor ingrese un valor maypr o igual a {0}.")
	},
