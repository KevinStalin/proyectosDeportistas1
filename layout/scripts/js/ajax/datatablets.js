      ...
      "columns":[
           ...
           {"render":
                ...
                function ( data, type, row ) {
                    ...
                    return "<div style='font-size:10px'>"+row['emailRealizado']+"</div>";
           ...
           {"render":
                ...
                function ( data, type, row ) {
                    ...
                    return "<div style='font-size:10px'>"+row['telefonoRealizado']+"</div>";
           ...
           {"render":
                ...
                function ( data, type, row ) {
                      ...
                      return "<div style='font-size:10px'>"+row['estado']+"</div>";
           ...
           {"render":
                ...
                function ( data, type, row ) {
                    ...
                    if (row['estado']=="AUN NO ES REVISADO" && row['nombreCompleto']!='no'){

                      return "<div style='font-size:10px'>"+'Se encuentra con '+row['nombreCompleto']+" sin ser revisado</div>";

                    }if(row['estado']=="CALIFICADO"){

                      return "<div style='font-size:10px'>"+'Calificado por'+row['nombreCompleto']+"</div><br><div style='font-size:10px'>Fecha:"+row['fechaCalifica']+"</br>";

                    }else if(row['estado']=="CERTIFICADO"){

                      return "<div style='font-size:10px'>"+'Certificado por'+row['nombreCompleto']+"</div>";

                    }else if(row['estado']=="NEGADO"){

                       return "<div style='font-size:10px'>"+row['observacionNiega']+"</div>";
           ...
           {"render":
                ...
                function ( data, type, row ) {
                    ...
                    return "<div style='font-size:10px'>"+row['periodoEjecucion']+"</div>";
