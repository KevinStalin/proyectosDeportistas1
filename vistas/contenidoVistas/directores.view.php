...
<div class="wrapper row3">
  ...
  <div class="contenido__general">
    ...
    <div class="contenedor__tabla">
      ...
      <table id="tablaProyectosDirectores" name="tablaProyectosDirectores" class="cell-border" border="2">
          ...
          <thead> 
              ...
              <tr> 
                  ...
                  <th class="tamanio__fuente__enfasis__tablas">Construcción</th>
                  <th class="tamanio__fuente__enfasis__tablas">FEDERACIÓN O DEPORTISTA</th>
                  <th class="tamanio__fuente__enfasis__tablas">CORREO</th>
