...
<div class="wrapper row3">
  ...
  <div class="contenido__general">
    ...
    <div class="contenedor__tabla">
      ...
      <table id="tablaProyectosSubsecretarios" name="tablaProyectosSubsecretarios" class="cell-border">
          ...
          <thead> 
              ...
              <tr> 
                  ...
                  <th class="tamanio__fuente__enfasis__tablas">FECHA DE INGRESO</th>
